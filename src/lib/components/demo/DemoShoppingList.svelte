<script lang="ts">
	...
	import EntryInput from '../shopping/EntryInput.svelte';
	import ListEntry from '../shopping/ListEntry.svelte';
	...
	export let enableCompleteSection = false;
	...
	>
		...
		>
			...
			<div slot="content">
				...
				<DishSearch {dishes} bind:filteredDishes />

...
// 		}
// 	];
// 	const newDishValid: ReadDish = {
// 		name: 'test4',
// 		url: 'https://google.com',
// 		user: 'test4'
// 	};
// 	const dishMissingName: ReadDish = {
// 		name: '',
// 		url: 'https://google.com',
// 		user: 'test4',
// 		ingredients: [{
// 			id: 1, value: 'test'}, { value: 'test2'}]
// 	};
...
// 	});
// 	it('isTimestampToday', () => {
// 		expect(DateHandler.isTimestampToday(new Date('03.21.2024'))).toBe('before');
// 		expect(DateHandler.isTimestampToday(new Date('03.21.2124'))).toBe('after');
// 	});
// });
